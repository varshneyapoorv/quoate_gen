...
// consmessage: "Goals and Objectives must be at least 20 characters long",t Understanding = ()=>{

//   const { setValue, trigger, formState: { errors }, register } = useFormContext();
//   const [editorContent, setEdito
// const Understanding = ({ sectionActive, resetSection }) => {
//   const { formState: { errors }, setValue, trigger, clearErrors } = useFormContext();
//   const [isPopupOpen, setIsPopupOpen] = useState(false); // State to manage popup visibility
//   const [textEditorContent, setTextEditorContent] = useState(""); // State to hold content for the normal text editor inside popup
...
// export default Understanding;rContent] = useState("");
...
//   // register the understanding with validation
